...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			...
			if ( '1' === $jewelry_comment_count ) {
				...
				printf( 
					...
					esc_html( _nx( '%1$s Comment', '%1$s Comments', $jewelry_comment_count, 'jewelry' ) ),
        ...
        comment_form(array('title_reply'=>'Send Comment', 'comment_notes_before'=>'',  'label_submit'=> 'send comment'));
	?>
